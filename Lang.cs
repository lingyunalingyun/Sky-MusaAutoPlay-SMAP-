...
public static class Lang
{
    ...
    static readonly Dictionary<string, string[]> T = new()
    {
        ...
        ["theme.sunset"] = new[] { "落日糖纸", "落日糖紙", "Sunset Candy", "夕焼けキャンディ" },
        ...
        ["midi.tracks"]    = new[] { "选择音轨:", "選擇音軌:", "Select tracks:", "トラックを選択:" },
        ["midi.notes"]     = new[] { "音符", "音符", "notes", "音符" },
        ["midi.autoalign"] = new[] { "🎯 自动移调对齐 C 大调 (减少走音, 推荐)", "🎯 自動移調對齊 C 大調 (減少走音, 推薦)", "🎯 Auto-transpose to C major (fewer off-notes, recommended)", "🎯 Cメジャーへ自動移調 (推奨)" },
        ["midi.aligned"]   = new[] { "自动移调 {0} 半音, 白键率 {1}%", "自動移調 {0} 半音, 白鍵率 {1}%", "Auto-transpose {0} semitones, {1}% white keys", "自動移調 {0} 半音, 白鍵率 {1}%" },
        ["midi.notrack"]   = new[] { "未选择音轨", "未選擇音軌", "No track selected", "トラック未選択" },
        ["midi.octave"]    = new[] { "八度偏移:", "八度偏移:", "Octave shift:", "オクターブ:" },
        ["midi.name"]      = new[] { "曲名:", "曲名:", "Title:", "曲名:" },
        ["midi.bpm"]       = new[] { "检测 BPM: {0}", "檢測 BPM: {0}", "Detected BPM: {0}", "検出 BPM: {0}" },
        ["midi.import"]    = new[] { "导入", "匯入", "Import", "インポート" },
        ["midi.pickone"]   = new[] { "请至少选择一个音轨", "請至少選擇一個音軌", "Select at least one track", "少なくとも1トラックを選択してください" },
        ["midi.noresult"]  = new[] { "转换后无音符", "轉換後無音符", "No notes after conversion", "変換後に音符がありません" },
        ["midi.defname"]   = new[] { "MIDI 导入", "MIDI 匯入", "MIDI Import", "MIDI インポート" },
